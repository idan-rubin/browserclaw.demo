# browserclaw.org — Project Instructions

## What This Project Is

browserclaw.org is an AI browser automation playground. Users type a prompt, watch the AI execute it in a real browser via live VNC stream, and get a reusable skill file as output.
